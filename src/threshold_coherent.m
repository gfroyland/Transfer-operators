function [youtmax,ioutmax,iout1,iout2]=threshold_coherent(b,P,leftvec,rightvec,step,p)
...
rightthreshvec=zeros(n,1);
leftthreshvec(iout1(1:ioutmax))=1;
leftthreshvec(setdiff(1:n,iout1(1:ioutmax)))=-1;
rightthreshvec(iout2(1:ioutmax))=1;
rightthreshvec(setdiff(1:n,iout2(1:ioutmax)))=-1;
figure;
subplot(2,1,1);show2plus(b,leftthreshvec)
subplot(2,1,2);show2plus(b,rightthreshvec)